...
import random
def deal_card():
    '''Returns a random card no'''
    cards = [11, 2, 3, 4, 5, 6, 7, 8, 9, 10, 10, 10, 10]
    return random.choice(cards)

def calculate_score(card_list):
    '''takes a list and return the total score i.e the sum of the list'''
...
def play_game():
    ...
    print(f"Computer's card: {computer_cards}, computer score: {comp_score} ")
